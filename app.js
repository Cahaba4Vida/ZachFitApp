...
const setupListeners = () => {
  ...
  addListener(elements.refreshProgram, "click", () => loadProgram().catch(console.error));
  ...
  addListener(elements.programChatSend, "click", async () => {
  ...
  addListener(elements.saveWorkout, "click", () => saveWorkoutLog().catch(console.error));
  addListener(elements.todayChatSend, "click", async () => {
